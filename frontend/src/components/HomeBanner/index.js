    ...
    return (
      <div className={COMPONENT_CLASS} style={{ height }}>
        <video
          ...
          loop
          autoPlay
          poster="/videos/hero-video-bg-poster.jpg"
        >
        ...
        <Container className={bem('content')}>
          <Row>
            <Col xs={12} lg={8} xl={6}>
              <h2 className={bem('title')}>Welcome to auction!</h2>
              <p className={bem('description')}>
                A do-gooder is what you can be with auction. We help you turn
                your things into lifesaving medicine, emergency services, and
                support for any charitable organization you choose.
              </p>
              <Link to="/mission" className={bem('link')}>
