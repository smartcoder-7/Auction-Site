      ...
      <div className={COMPONENT_CLASS}>
        <Container>
            ...
            <Row>
              <Col xs={12} sm={6} md={3}>
                ...
                <Nav vertical className={bem('nav')}>
                  ...
                  <NavItem>
                    <NavLink tag={Link} to="/authenticity">
                      Authenticity
                    </NavLink>
                  </NavItem>
                  <NavItem>
              ...
              <Col xs={12} sm={6} md={3}>
                ...
                <Nav vertical className={bem('nav')}>
                  ...
                  <NavItem>
                    <NavLink tag={Link} to="/influencer-program">
                      Influencer Program
                    </NavLink>
                  </NavItem>
                  <NavItem>
                    <NavLink tag={Link} to="/terms-conditions">
                      Terms of Service
                    </NavLink>
                  </NavItem>
                  <NavItem>
              ...
              <Col xs={12} sm={6} md={3}>
                ...
                <Nav vertical className={bem('nav')}>
                  <NavItem>
                    <NavLink tag={Link} to="/auctions/new-arrivals">
                      New Arrivals
                    </NavLink>
                  </NavItem>
                  <NavItem>
                    <NavLink tag={Link} to="/auctions?category=women">
                      Women
                    </NavLink>
                  </NavItem>
                  <NavItem>
                    <NavLink tag={Link} to="/auctions?category=men">
                      Men
                    </NavLink>
                  </NavItem>
                  <NavItem>
                    <NavLink tag={Link} to="/auctions?category=accessories">
                      Accessories
                    </NavLink>
                  </NavItem>
                  <NavItem>
                    <NavLink tag={Link} to="/auctions?category=staff-picks">
                      Staff Picks
                    </NavLink>
                  </NavItem>
                </Nav>
          ...
          <Nav className={bem('social')}>
            ...
            <NavItem>
              <SocialLink href="https://plus.google.com/">
                <TiSocialGooglePlus />
              </SocialLink>
            </NavItem>
          </Nav>
          ...
          <div className={bem('copyright')}>
            <div className={bem('copyright-item')}>Your Goods. Doing Good.</div>
            <div className={bem('copyright-item')}>
              &copy; auction 2017-2018 All Rights Reserved
            </div>
          </div>
        </Container>
      </div>
