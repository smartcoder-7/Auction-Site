...
const InfluencerProgram = () => (
  ...
  >
    <Section className="page-content">
      <p>
        We’ve noticed that you’ve been sharing the word about auction, so we’ve
        ...
        program rewards you for championing the auction platform and experience
        by giving you incentives we think you’ll appreciate.
      </p>
      <ul>
        <li>Cash payouts for each new seller that submits their items</li>
        <li>
          Invitations to private events we host just for auction affiliates
        </li>
        <li>
      ...
      <p>
        We’re honored by your support and excited to invite you to join our
        Influencer Program!
      </p>
      <p>We hope you’ll enjoy being a part of our community.</p>
    </Section>
    <ContactTextLink />
  </FrontContainerLayout>
);
